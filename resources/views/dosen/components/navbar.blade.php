                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center text-white px-3 py-2" href="#"
                        ...
                        <div class="d-flex flex-grow-1 align-items-center justify-content-between">
                            <div class="d-flex flex-column me-2">
                                <span class="fw-semibold text-white" style="line-height: 1.2">{{ Auth::guard('dosen')->user()->dosen->nama ?? '-' }}</span>
                                <span class="text-white-60 text-sm">{{ Auth::guard('dosen')->user()->dosen->nip ?? '-' }}</span>
                            </div>
                        </div>
                    </a>
