    ...
    <div class="card p-4">
       ...
       <form class="mt-1">
            <div class="form-group">
                ...
                <input class="form-control" value="362355401017" type="text">
            </div>
            <div class="form-group">
                <label for="nama" class="form-control-label">Nama Mahasiswa</label>
                <input class="form-control" value="Achmad Nico Wildhan" type="text">
            </div>
            <div class="form-group">
                <label for="kelas" class="form-control-label">Kelas</label>
                <input class="form-control" value="3A" type="text">
            </div>
