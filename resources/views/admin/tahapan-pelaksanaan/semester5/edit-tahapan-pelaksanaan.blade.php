       ...
       <form class="mt-1">
            <div class="form-group">
                ...
                <select class="form-control" id="minggu">
                    <option disabled>Pilih Minggu Pelaksanaan</option>
                    <option selected>Minggu Ke-1</option>
            ...
            <div class="form-group">
                ...
                <input class="form-control" value="Mengidentifikasi fitur tambahan yang akan dikembangkan dalam waktu pelaksanaan proyek" type="text">
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="pic">
                    ...
                    <option selected>[perwakilan tim]</option>
                    <option>[manajer proyek]</option>
                </select>
            </div>
            <div class="form-group">
                <label for="bobot-progress" class="form-control-label">Bobot Progres Proyek</label>
                <input class="form-control" type="number" id="bobot-progress" value="5" max="10" min="5">
            </div>
