@php
    $routes = [
        ...
        // Tim PBL
        'mahasiswa.rpp' => 'Rencana Pelaksanaan Proyek',
    ];

    $currentRoute = Route::currentRouteName();
    $pageTitle = $routes[$currentRoute] ?? 'Dashboard'; // Default jika tidak ditemukan
@endphp
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="{{ route('mahasiswa.dashboard') }}">Pages</a></li>
            ...
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-dark d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('assets/img/team-4.jpg') }}" alt="User Avatar" class="rounded-circle me-2" width="40" height="40">
